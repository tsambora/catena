...
contractObject.getContractInstance(bniAddr, [10000000000])
  .then((contractInstance) => {
    ...
    contractInstance.transfer(bniAddr, merchantAddr, 100000, bniToMerchantToken, rsv.v, rsv.r, rsv.s)
    ...
    contractInstance.transfer(bniAddr, buyerAddr, 1000000, bniToBuyerToken, rsv.v, rsv.r, rsv.s)
